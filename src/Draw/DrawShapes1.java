 ...
 * @since 2019-12-01
 */
public class DrawShapes1 extends JPanel {
	//Attributes
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {			//Program runs inside an EventQueue
			public void run() {
				...
				frame.setTitle("Draw12b Shapes");			//Set the attributes of the frame object
				frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				frame.setResizable(false);
				frame.setLocationByPlatform(true);
				frame.setContentPane(new DrawPanel1());	//Create a new DrawPanel object and sets the content pane of the frame to it
